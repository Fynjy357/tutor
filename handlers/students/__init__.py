...
from .report_editor import router as report_editor_router 
from .inactive import inactive_students_router
...
router.include_router(report_editor_router) 
router.include_router(inactive_students_router)
...
__all__ = [
    ...
    'add_students_router',
    'report_editor_router',
    'inactive_students_router' 
]